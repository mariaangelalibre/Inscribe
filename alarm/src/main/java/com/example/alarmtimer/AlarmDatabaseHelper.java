...
public class AlarmDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addAlarm (AlarmTime alarm) {
    ...
    public List<AlarmTime> getAllAlarms() {
        List<AlarmTime> alarmList = new ArrayList<>();
    ...
    public int updateAlarm(AlarmTime alarm){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_ALARM_HOUR, alarm.getHour());
        values.put(COLUMN_ALARM_MINUTE, alarm.getMinute());
    ...
    public int deleteAlarm(AlarmTime alarm){
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(TABLE_NAME, COLUMN_ALARM_ID + " = ?",
                new String[]{String.valueOf(alarm.getId())});
    }
}
